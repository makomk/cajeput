...
clean:
	rm -f server_demo cajeput_sim sl_llsd_test *.o sl_messages.[ch]
...
server_demo.o: server_demo.cpp cajeput_core.h cajeput_udp.h cajeput_int.h sl_messages.h sl_types.h sl_llsd.h
